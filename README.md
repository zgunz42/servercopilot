...
- **CI/CD** via [GitHub Actions](https://github.com/features/actions)
  ...
  - `.github/workflows/build-release.yml` for releasing a version, in which GitHub Actions:
    ...
    2. Pushes the image to [GitHub Container Registry](https://github.com/zgunz42/servercopilot/pkgs/container/gofiber-template)
    3. Creates a [GitHub Release](https://github.com/zgunz42/servercopilot/releases) with automatically generated [GitHub Release Notes](https://docs.github.com/en/repositories/releasing-projects-on-github/automatically-generated-release-notes) via [marvinpinto/action-automatic-releases](https://github.com/marvinpinto/action-automatic-releases)
